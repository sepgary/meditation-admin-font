<template>
    <div class="app-container">
      <div class="filter-container">
        <el-input v-model="pageQuery.userId" placeholder="ID" style="width: 130px"/>
      ...
      <el-table-column label="昵称" prop="name" width="70"/>
      <el-table-column label="HashId" prop="hashId" width="180"/>

      <el-table-column label="年龄" align="center" prop="age" width="70"/>
      <el-table-column label="微信统一ID" align="center" prop="unionid" width="100"/>
      <el-table-column label="手机号" align="center" prop="phone" width="150"/>

      <el-table-column label="vip到期时间" align="center" prop="vipExpireTime" width="150"/>
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        userAPI.getPageList(this.pageQuery).then(response => {
          for (let i = 0; i < response.data.items.length; i ++) {
            response.data.items[i].vipExpireTime = new Date(response.data.items[i].vipExpireTime * 1000) + ''
          }
